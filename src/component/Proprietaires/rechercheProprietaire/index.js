...
export default function RechercheProprietaire() {
    ...
    const filteredProprietaires = proprietaires.filter(proprietaire =>
        proprietaire.Nom.toLowerCase().includes(searchNom.toLowerCase()) &&
        proprietaire.Prenom.toLowerCase().includes(searchPrenom.toLowerCase()) &&
        proprietaire.Ville.toLowerCase().includes(searchVille.toLowerCase())
    ...
    const renderItem = ({ item }) => (
        <View style={styles.item}>
            ...
            <TouchableOpacity style={[styles.itemColumn, styles.itemButton]} onPress={() => navigation.navigate('InformationsProprietaire', { proprietaire: item })}>
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity
                ...
                onPress={() => navigation.navigate("AjouterProprietaire")}>
                <Text style={{ color: "white" }}>Créer un proprietaire</Text>
            </TouchableOpacity>
