...
const AjouterProprietaire = ({ navigation }) => {
    const handleAddProprietaire = (values) => {
        ...
        apiProprietaire.add(newProprietaire);
        navigation.goBack();
    };
            ...
            >
                {({ handleChange, handleBlur, handleSubmit, values, errors }) => (
                    <>
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Entrez le nom du proprietaire"
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Entrez le prénom du proprietaire"
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Entrez le téléphone du proprietaire"
                        ...
                        <TextInput style={styles.input}
                                   placeholder="Entrez le nom de rue du proprietaire"
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Entrez le numéro de rue du proprietaire"
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Entrez la ville du proprietaire"
                        ...
                        <TextInput
                            style={styles.input}
                            placeholder="Entrez le code postal du proprietaire"
                        ...
                        <Button title="Ajouter le proprietaire" onPress={handleSubmit} />
                    </>
                )}
            </Formik>
        </View>
